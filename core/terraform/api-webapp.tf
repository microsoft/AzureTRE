...
resource "azurerm_linux_web_app" "api" {
  ...
  app_settings = {
    ...
    "AAD_TENANT_ID"                                  = "@Microsoft.KeyVault(SecretUri=${azurerm_key_vault.kv.vault_uri}secrets/${azurerm_key_vault_secret.aad_tenant_id.name}/${azurerm_key_vault_secret.aad_tenant_id.version})"
