...
# Migrate the original legacy resource singleton addresses to the new counted
# addresses in storage_accounts_v1.tf so existing deployments preserve their
# legacy state objects without churning the legacy accounts.
moved {
