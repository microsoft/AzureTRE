...
resource "azurerm_application_gateway" "agw" {
  ...
  ssl_profile {     
    name = "agw-${var.tre_id}-ssl-profile"     
    ssl_policy {
  ...
  lifecycle { ignore_changes = [ssl_certificate, tags, zones, url_path_map, backend_http_settings, backend_address_pool, rewrite_rule_set] }
