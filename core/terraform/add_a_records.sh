...
# Find IP of Synapse SQL Private Endpoint - privateIPAddress needs to be with an uppercase IP because of the newer version of az-cli
...
# Find IP of Synapse SQL Ondemand Private Endpoint - privateIPAddress needs to be with an uppercase IP because of the newer version of az-cli
