...
# =============================================================================
# DEPRECATED: This script is for workspace bundles < v3.0.0 that use auth_type.
# For workspace bundles v3.0.0+, use create_workspace_application.sh instead.
# This script will be removed when bundles < v3.0.0 are no longer supported.
# =============================================================================
...
DEPRECATED: Use create_workspace_application.sh for workspace bundles v3.0.0+.
