...
class Operation(ModelNormal):
    ...
    attribute_map = {
        ...
        'created_when': 'createdWhen',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, resource_id, _resource_path, action, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            resource_version (int): Version of the resource this operation relates to. [optional] if omitted the server will use the default value of 0  # noqa: E501
            status (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
            message (str): [optional] if omitted the server will use the default value of ""  # noqa: E501
            created_when (float): [optional]  # noqa: E501
            updated_when (float): [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, resource_id, _resource_path, action, *args, **kwargs):  # noqa: E501
        """Operation - a model defined in OpenAPI
