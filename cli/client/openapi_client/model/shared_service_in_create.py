...
class SharedServiceInCreate(ModelNormal):
    ...
    def _from_openapi_data(cls, template_name, *args, **kwargs):  # noqa: E501
        """SharedServiceInCreate - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            properties ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Values for the parameters required by the shared service resource specification. [optional] if omitted the server will use the default value of {}  # noqa: E501
        """
