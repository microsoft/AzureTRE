...
class ResourceType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Type of resource to deploy., must be one of ["workspace", "workspace-service", "user-resource", "shared-service", ]  # noqa: E501

        Keyword Args:
            value (str): Type of resource to deploy., must be one of ["workspace", "workspace-service", "user-resource", "shared-service", ]  # noqa: E501
