...
Templates authors need to make sure that underlying Azure resources are tagged with the relevant tags, for more information see [cost reporting](../azure-tre-overview/cost-reporting.md#azure-resources-tagging):
