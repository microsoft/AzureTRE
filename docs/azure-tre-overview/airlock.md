...
graph TB
    ...
    researcher -- "SAS token" --> CoreStorage
    reviewer -- "SAS token" --> CoreStorage
...
@Environment[Microsoft.Network/privateEndpoints]
    == '/subscriptions/.../resourceGroups/.../providers/Microsoft.Network/privateEndpoints/pe-sa-airlock-ws-global-{workspace_short_id}'
  AND
