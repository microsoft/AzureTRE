...
To use the legacy architecture, set `airlock_version: 1` in your workspace properties, overriding the default value of `2`, and ensure `enable_legacy_airlock: true` is set in your `config.yaml`.
