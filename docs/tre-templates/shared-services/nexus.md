...
| Docker (group) | apt group | [https://download.docker.com/linux/ubuntu/] | `https://nexus-{TRE_ID}.{LOCATION}.cloudapp.azure.com/repository/docker/` | Install Docker via apt on Linux systems; routes requests to the correct per-release proxy member. |
| Docker Bionic (member) | apt | [https://download.docker.com/linux/ubuntu/] | `https://nexus-{TRE_ID}.{LOCATION}.cloudapp.azure.com/repository/docker-bionic/` | Docker apt proxy for Ubuntu 18.04 (bionic). |
| Docker Jammy (member) | apt | [https://download.docker.com/linux/ubuntu/] | `https://nexus-{TRE_ID}.{LOCATION}.cloudapp.azure.com/repository/docker-jammy/` | Docker apt proxy for Ubuntu 22.04 (jammy). |
...
| Ubuntu Packages (group) | apt group | [http://archive.ubuntu.com/ubuntu/] | `https://nexus-{TRE_ID}.{LOCATION}.cloudapp.azure.com/repository/ubuntu/` | Stable group URL for Ubuntu apt packages; routes bionic/jammy requests to the correct proxy member. |
| Ubuntu Bionic Packages (member) | apt | [http://archive.ubuntu.com/ubuntu/] | `https://nexus-{TRE_ID}.{LOCATION}.cloudapp.azure.com/repository/ubuntu-bionic/` | Ubuntu apt proxy for Ubuntu 18.04 (bionic). |
| Ubuntu Jammy Packages (member) | apt | [http://archive.ubuntu.com/ubuntu/] | `https://nexus-{TRE_ID}.{LOCATION}.cloudapp.azure.com/repository/ubuntu-jammy/` | Ubuntu apt proxy for Ubuntu 22.04 (jammy). |
| Ubuntu Security (group) | apt group | [http://security.ubuntu.com/ubuntu/] | `https://nexus-{TRE_ID}.{LOCATION}.cloudapp.azure.com/repository/ubuntu-security/` | Stable group URL for Ubuntu security apt packages; routes bionic/jammy requests to the correct proxy member. |
| Ubuntu Security Bionic (member) | apt | [http://security.ubuntu.com/ubuntu/] | `https://nexus-{TRE_ID}.{LOCATION}.cloudapp.azure.com/repository/ubuntu-security-bionic/` | Ubuntu security apt proxy for Ubuntu 18.04 (bionic). |
| Ubuntu Security Jammy (member) | apt | [http://security.ubuntu.com/ubuntu/] | `https://nexus-{TRE_ID}.{LOCATION}.cloudapp.azure.com/repository/ubuntu-security-jammy/` | Ubuntu security apt proxy for Ubuntu 22.04 (jammy). |
...
| Microsoft Apt (group) | apt group | [https://packages.microsoft.com] | `https://nexus-{TRE_ID}.{LOCATION}.cloudapp.azure.com/repository/microsoft-apt` | Stable group URL for Microsoft apt packages; routes bionic/jammy requests to the correct proxy member. |
| Microsoft Apt Bionic (member) | apt | [https://packages.microsoft.com] | `https://nexus-{TRE_ID}.{LOCATION}.cloudapp.azure.com/repository/microsoft-apt-bionic/` | Microsoft apt proxy for Ubuntu 18.04 (bionic). |
| Microsoft Apt Jammy (member) | apt | [https://packages.microsoft.com] | `https://nexus-{TRE_ID}.{LOCATION}.cloudapp.azure.com/repository/microsoft-apt-jammy/` | Microsoft apt proxy for Ubuntu 22.04 (jammy). |
