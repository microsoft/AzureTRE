...
|AUTO_GRANT_WORKSPACE_CONSENT| Default of `false`.  Setting this to true will prevent users from needing to grant consent to new workspaces. The identity will be granted `Application.ReadWrite.All` and `Directory.ReadWrite.All` permissions.|
