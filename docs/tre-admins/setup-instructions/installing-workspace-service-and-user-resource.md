...
1. Run:
    ...
    make bundle-register DIR=./templates/workspace_services/guacamole/user_resources/guacamole-azure-windowsvm BUNDLE_TYPE=user_resource USER_RESOURCE_NAME=tre-service-guacamole
    ```
