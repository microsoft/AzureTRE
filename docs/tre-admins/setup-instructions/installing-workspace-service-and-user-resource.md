...
1. Run:
    ...
    make bundle-register DIR=./templates/workspace_services/guacamole/user_resources/guacamole-azure-windowsvm BUNDLE_TYPE=user_resource WOKSPACE_SERVICE_NAME=tre-service-guacamole
    ```
