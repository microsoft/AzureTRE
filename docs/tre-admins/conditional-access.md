...
4. Under **Assignments**:
   ...
   - **Cloud apps or actions**: Select **All cloud apps** to automatically cover all TRE applications including future workspace applications
...
!!! warning "Important: Use 'All cloud apps' for TRE-wide policies"
    For TRE-wide policies, always use "All cloud apps" to ensure comprehensive and automatic coverage of all workspace applications. Selecting specific applications is not sustainable as it requires manual updates each time a workspace is created, which can lead to security gaps.
...
3. Under **Assignments**:
   ...
   - **Cloud apps**: Select **All cloud apps** to cover all TRE applications
