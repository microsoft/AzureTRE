...
* Increase the Guacamole user-resources API timeout default and make it configurable to avoid login failures in large workspaces. (`tre-service-guacamole` 0.14.6) ([#5099](https://github.com/microsoft/AzureTRE/issues/5099))
