...
* Fix clean validation workflow failing due to azure-firewall extension checksum mismatch by pre-installing the extension explicitly ([#4971](https://github.com/microsoft/AzureTRE/issues/4971))
