...
## (Unreleased)
**BREAKING CHANGES**
* Remove Windows 10 image support from Guacamole. ([#4890](https://github.com/microsoft/AzureTRE/issues/4890))
...
* Add Windows Server 2022 DSVM image support to Guacamole. ([#4890](https://github.com/microsoft/AzureTRE/issues/4890))
