...
ENHANCEMENTS:
* Add comprehensive documentation for Conditional Access Policies and MFA usage, covering TRE-wide and per-workspace configurations ([#ISSUE_NUMBER](https://github.com/microsoft/AzureTRE/issues/ISSUE_NUMBER))
