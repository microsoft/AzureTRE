...
## 0.26.0 (Unreleased)
**BREAKING CHANGES**
* The firewall nework rule collection nrc-general containing the "time" ntp firewall rule has been removed. If you require NTP you can specify your own rules via a template pipeline.([#4710](https://github.com/microsoft/AzureTRE/pull/4710))
