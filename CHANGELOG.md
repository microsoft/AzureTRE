...
ENHANCEMENTS:
* Add comprehensive documentation for Conditional Access Policies and MFA usage, covering TRE-wide and per-workspace configurations ([#4834](https://github.com/microsoft/AzureTRE/issues/4834))
