...
* Fix terraform output command by adding working directory parameter and updating terraform wrapper script PR ([#4413](https://github.com/microsoft/AzureTRE/pull/4413))  [#4412](https://github.com/microsoft/AzureTRE/issues/4412)
