...
BUG FIXES:
* Defer scheduled CI environment cleanup while other GitHub Actions runs are active or queued, including PR tests started by comments. ([#5087](https://github.com/microsoft/AzureTRE/pull/5087))
