...
ENHANCEMENTS:
* Add a Guacamole Linux container desktop on Azure Container Instances for faster provisioning than VM-based desktops. ([#4311](https://github.com/microsoft/AzureTRE/issues/4311))
