...
BUG FIXES:
* Prevent disabling Airlock on v2 workspaces because removing the per-workspace signer would make retained shared request containers impossible to clean up safely ([#5048](https://github.com/microsoft/AzureTRE/pull/5048))
