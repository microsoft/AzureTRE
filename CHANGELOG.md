...
BUG FIXES:
* Create workspace backup Recovery Services vaults with AzAPI to avoid AzureRM soft delete update failures during initial deployment ([#4907](https://github.com/microsoft/AzureTRE/pull/4907))
