...
BUG FIXES:
* Ignore changes to `ip_tags` on public IP resources to unblock deployments where these tags are set by Azure policy ([#5019](https://github.com/microsoft/AzureTRE/issues/5019))
