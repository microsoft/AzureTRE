...
TEST_AUTOMATION_ACCOUNT_CLIENT_ID: str = config("TEST_AUTOMATION_ACCOUNT_CLIENT_ID", default="")
TEST_AUTOMATION_ACCOUNT_CLIENT_SECRET: str = config("TEST_AUTOMATION_ACCOUNT_CLIENT_SECRET", default="")
