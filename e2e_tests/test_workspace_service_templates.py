...
async def test_get_workspace_service_templates(template_name, verify, admin_token) -> None:
...
@pytest.mark.smoke
@pytest.mark.parametrize("template_name", workspace_service_templates)
async def test_get_workspace_service_template(template_name, verify, admin_token) -> None:
...
@pytest.mark.smoke
async def test_create_workspace_service_templates(verify, admin_token) -> None:
    async with AsyncClient(verify=verify) as client:
        payload = {
