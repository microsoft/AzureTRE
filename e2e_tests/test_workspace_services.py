...
async def test_create_guacamole_service_into_base_workspace(setup_test_base_workspace_and_guacamole_service, verify) -> None:
    _, workspace_id, workspace_service_path, _ = setup_test_base_workspace_and_guacamole_service
...
async def test_install_workspace_service(template_name, verify, setup_test_base_workspace) -> None:
