...
async def test_get_shared_service_templates(template_name, verify, admin_token) -> None:
...
@pytest.mark.smoke
@pytest.mark.parametrize("template_name", shared_service_templates)
async def test_get_shared_service_template(template_name, verify, admin_token) -> None:
