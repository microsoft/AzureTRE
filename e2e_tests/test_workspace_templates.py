...
async def test_get_workspace_templates(template_name, verify, admin_token) -> None:
...
@pytest.mark.smoke
@pytest.mark.parametrize("template_name", workspace_templates)
async def test_get_workspace_template(template_name, verify, admin_token) -> None:
