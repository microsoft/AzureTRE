...
async def test_get_airlock_requests_by_user_and_workspace_with_awaiting_my_review_and_status_arguments_should_ignore_status(airlock_review_repo_mock):
    ...
    airlock_review_repo_mock.get_airlock_requests_by_workspace_id.assert_called_once_with(workspace_id=workspace.id, user_id=None, type=None, status=AirlockRequestStatus.InReview)
