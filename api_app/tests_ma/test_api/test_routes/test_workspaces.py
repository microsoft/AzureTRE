...
class TestWorkspaceHelpers:
    ...
    async def test_save_and_deploy_resource_raises_503_if_send_request_fails(self, send_resource_request_mock, resource_repo):
        resource = sample_workspace(str(uuid.uuid4()))
        resource_repo.save_item = MagicMock(return_value=None)
    ...
    @patch("api.routes.workspaces.send_resource_request_message")
    async def test_save_and_deploy_resource_deletes_item_from_db_if_send_request_fails(self, send_resource_request_mock, resource_repo):
        resource = sample_workspace(str(uuid.uuid4()))
        resource_repo.save_item = MagicMock(return_value=None)
        resource_repo.delete_item = MagicMock(return_value=None)
        send_resource_request_mock.side_effect = Exception
...
class TestWorkspaceRoutesThatDontRequireAdminRights:
    ...
    async def test_get_workspace_by_id_get_returns_404_if_resource_is_not_found(self, get_workspace_mock, app, client):
    ...
    # [GET] /workspaces/{workspace_id}
    @ patch("api.dependencies.workspaces.WorkspaceRepository.get_workspace_by_workspace_id")
    async def test_get_workspace_by_id_get_returns_422_if_workspace_id_is_not_a_uuid(self, get_workspace_mock, app, client):
        get_workspace_mock.side_effect = EntityDoesNotExist
...
class TestWorkspaceRoutesThatRequireAdminRights:
    ...
    async def test_post_workspaces_creates_workspace(self, create_workspace_item_mock, _, __, app, client, workspace_input):
    ...
    async def test_post_workspaces_calls_db_and_service_bus(self, validate_workspace_parameters_mock, create_workspace_item_mock, save_item_mock, send_resource_request_message_mock, app, client, workspace_input):
        workspace_id = "000000d3-82da-4bfc-b6e9-9a7853ef753e"
    ...
    @ patch("api.routes.workspaces.WorkspaceRepository.create_workspace_item")
    @ patch("api.routes.workspaces.WorkspaceRepository._validate_resource_parameters")
    async def test_post_workspaces_returns_202_on_successful_create(self, validate_workspace_parameters_mock, create_workspace_item_mock, _, __, app, client, workspace_input):
        workspace_id = "000000d3-82da-4bfc-b6e9-9a7853ef753e"
        validate_workspace_parameters_mock.return_value = None
        create_workspace_item_mock.return_value = sample_workspace(workspace_id)
    ...
    @ patch("api.routes.workspaces.WorkspaceRepository.create_workspace_item")
    @ patch("api.routes.workspaces.WorkspaceRepository._validate_resource_parameters")
    async def test_post_workspaces_returns_503_if_service_bus_call_fails(self, validate_workspace_parameters_mock, create_workspace_item_mock, _, send_resource_request_message_mock, delete_item_mock, app, client, workspace_input):
        workspace_id = "000000d3-82da-4bfc-b6e9-9a7853ef753e"
        validate_workspace_parameters_mock.return_value = None
        create_workspace_item_mock.return_value = sample_workspace(workspace_id)
    ...
    async def test_post_workspaces_returns_400_if_template_does_not_exist(self, validate_input_mock, app, client, workspace_input):
    ...
    @ patch("api.dependencies.workspaces.WorkspaceRepository.get_workspace_by_workspace_id")
    async def test_patch_workspaces_returns_404_if_workspace_does_not_exist(self, get_workspace_mock, app, client):
        get_workspace_mock.side_effect = EntityDoesNotExist
        workspace_id = "933ad738-7265-4b5f-9eae-a1a62928772e"
    ...
    @ patch('api.routes.workspaces.send_resource_request_message')
    async def test_delete_workspace_deletes_workspace(self, _, delete_workspace_mock, cosmos_client_mock, get_active_workspace_services_for_workspace_mock, get_workspace_mock, get_repository_mock, disabled_workspace, app, client):
        get_workspace_mock.return_value = disabled_workspace
    ...
    @ patch('api.routes.workspaces.WorkspaceRepository.mark_resource_as_deleting')
    @ patch('api.routes.workspaces.send_resource_request_message')
    async def test_delete_workspace_sends_a_request_message_to_uninstall_the_workspace(self, send_request_message_mock, _, cosmos_client_mock, get_active_workspace_services_for_workspace_mock, get_workspace_mock, get_repository_mock, disabled_workspace, app, client):
        get_workspace_mock.return_value = disabled_workspace
        get_active_workspace_services_for_workspace_mock.return_value = []
        get_repository_mock.side_effects = [WorkspaceRepository(cosmos_client_mock), WorkspaceServiceRepository(cosmos_client_mock)]
    ...
    async def test_delete_workspace_reverts_the_workspace_if_service_bus_call_fails(self, restore_previous_deletion_state_mock, send_request_message_mock, _, cosmos_client_mock, get_active_workspace_services_for_workspace_mock, get_workspace_mock, get_repository_mock, disabled_workspace, app, client):
        get_workspace_mock.return_value = disabled_workspace
        get_active_workspace_services_for_workspace_mock.return_value = []
        get_repository_mock.side_effects = [WorkspaceRepository(cosmos_client_mock), WorkspaceServiceRepository(cosmos_client_mock)]
...
class TestWorkspaceServiceRoutesThatDontRequireAdminRights:
    ...
    @ patch("api.dependencies.workspaces.WorkspaceRepository.get_workspace_by_workspace_id")
    @ patch("api.routes.workspaces.validate_user_has_valid_role_in_workspace", return_value=None)
    ...
    async def test_post_workspace_services_creates_workspace_service(self, create_workspace_service_item_mock, _, __, get_workspace_mock, app, client, workspace_service_input):
    ...
    @ patch("api.dependencies.workspaces.WorkspaceServiceRepository.get_workspace_service_by_id")
    async def test_patch_workspaces_service_returns_404_if_workspace_service_does_not_exist(self, get_workspace_service_mock, app, client):
    ...
    @ patch("api.dependencies.workspaces.WorkspaceServiceRepository.get_workspace_service_by_id")
    @ patch("api.dependencies.workspaces.WorkspaceRepository.get_workspace_by_workspace_id")
    async def test_patch_workspaces_service_returns_404_if_workspace_does_not_exist(self, get_workspace_mock, get_workspace_service_mock, app, client):
        get_workspace_mock.side_effect = EntityDoesNotExist
...
class TestUserResourcesRoutesThatDontRequireAdminRights:
    ...
    # [POST] /workspaces/{workspace_id}/workspace-services/{service_id}/user-resources
    @patch("api.dependencies.workspaces.WorkspaceRepository.get_deployed_workspace_by_workspace_id")
    async def test_post_user_resources_with_non_existing_workspace_id_returns_404(self, get_workspace_mock, app, client, sample_user_resource_input_data):
        workspace_id = "98b8799a-7281-4fc5-91d5-49684a4810ff"
        parent_workspace_service_id = "937453d3-82da-4bfc-b6e9-9a7853ef753e"
    ...
    @patch("api.dependencies.workspaces.WorkspaceRepository.get_deployed_workspace_by_workspace_id")
    @patch("api.dependencies.workspaces.WorkspaceServiceRepository.get_deployed_workspace_service_by_id")
    async def test_post_user_resources_with_non_existing_service_id_returns_404(self, get_workspace_service_mock, get_workspace_mock, app, client, sample_user_resource_input_data):
        workspace_id = "98b8799a-7281-4fc5-91d5-49684a4810ff"
        parent_workspace_service_id = "937453d3-82da-4bfc-b6e9-9a7853ef753e"
