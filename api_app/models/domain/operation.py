...
class OperationStep(AzureTREModel):
    ...
    updatedWhen: Optional[float] = Field(default=None, title="POSIX Timestamp for When the operation step was updated")
...
class Operation(AzureTREModel):
    ...
    status: Status = Field(Status.AwaitingDeployment, title="Operation status")
