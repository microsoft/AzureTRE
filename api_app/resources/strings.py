...
API_GET_WORKSPACE_STORAGE_INFO="Get the workspace storage information"
...
API_GET_EMSL_WORKSPACES = " Get all E-msl workspaces that are not connected to A-msl"
API_DEPLOYMENT_STATUS = " Check any deployement is running"
...
API_UPDATE_DELETE_USER_RESOURCE = "Update and delete an existing user resource"
...
API_TO_GET_AIRLOCK_STATUS="Get Airlock Process status"
API_TO_SET_AIRLOCK_STATUS="Set Airlock Process status"
...
API_EXPORT_IMPORT_FILE="Create airlock request for Export or Import operation"
