...
WORKSPACE_HAS_ADDRESS_SPACE_CLEANUP = "Workspace address space cleanup is in progress"
...
SHARED_SERVICE_TEMPLATE_VERSION_EXISTS = "A template with the same version, or a newer version already exists"
...
ADDRESS_SPACE_CLEANUP_LOCK_PROPERTY = "_address_space_cleanup_lock"
ADDRESS_SPACE_CLEANUP_LOCK_EXPIRY_SECONDS = 900
