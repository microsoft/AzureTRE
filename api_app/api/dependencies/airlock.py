...
async def get_airlock_request_by_id_from_path(airlock_request_id: UUID4 = Path(...), airlock_request_repo=Depends(AirlockRequestRepository.get_repository())) -> AirlockRequest:
