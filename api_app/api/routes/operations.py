...
async def get_my_operations(user=Depends(get_current_tre_user_or_tre_admin), operations_repo=Depends(Database().get_repository(OperationRepository))) -> OperationInList:
