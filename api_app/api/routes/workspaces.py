...
async def retrieve_users_active_workspaces(request: Request, user=Depends(get_current_tre_user_or_tre_admin), workspace_repo=Depends(WorkspaceRepository.get_repository()), resource_template_repo=Depends(ResourceTemplateRepository.get_repository())) -> WorkspacesInList:
...
async def retrieve_workspace_by_workspace_id(workspace=Depends(get_workspace_by_id_from_path), resource_template_repo=Depends(ResourceTemplateRepository.get_repository())) -> WorkspaceInResponse:
...
async def invoke_action_on_workspace(response: Response, action: str, user=Depends(get_current_admin_user), workspace=Depends(get_workspace_by_id_from_path), resource_template_repo=Depends(ResourceTemplateRepository.get_repository()), operations_repo=Depends(OperationRepository.get_repository()), workspace_repo=Depends(WorkspaceRepository.get_repository()), resource_history_repo=Depends(ResourceHistoryRepository.get_repository())) -> OperationInResponse:
...
async def get_workspace_service_templates(
        ...
        template_repo=Depends(ResourceTemplateRepository.get_repository()),
...
async def retrieve_workspace_operations_by_workspace_id(workspace=Depends(get_workspace_by_id_from_path), operations_repo=Depends(OperationRepository.get_repository())) -> OperationInList:
...
async def retrieve_workspace_history_by_workspace_id(workspace=Depends(get_workspace_by_id_from_path), resource_history_repo=Depends(ResourceHistoryRepository.get_repository())) -> ResourceHistoryInList:
...
async def retrieve_users_active_workspace_services(workspace=Depends(get_workspace_by_id_from_path), workspace_services_repo=Depends(WorkspaceServiceRepository.get_repository()), resource_template_repo=Depends(ResourceTemplateRepository.get_repository())) -> WorkspaceServicesInList:
...
async def retrieve_workspace_service_by_id(workspace_service=Depends(get_workspace_service_by_id_from_path), resource_template_repo=Depends(ResourceTemplateRepository.get_repository())) -> WorkspaceServiceInResponse:
...
async def invoke_action_on_workspace_service(response: Response, action: str, user=Depends(get_current_workspace_owner_user), workspace_service=Depends(get_workspace_service_by_id_from_path), resource_template_repo=Depends(ResourceTemplateRepository.get_repository()), operations_repo=Depends(OperationRepository.get_repository()), workspace_service_repo=Depends(WorkspaceServiceRepository.get_repository()), resource_history_repo=Depends(ResourceHistoryRepository.get_repository())) -> OperationInResponse:
    operation = await send_custom_action_message(
        resource=workspace_service,
        resource_repo=workspace_service_repo,
        custom_action=action,
...
async def retrieve_workspace_service_operations_by_workspace_service_id(workspace_service=Depends(get_workspace_service_by_id_from_path), operations_repo=Depends(OperationRepository.get_repository())) -> OperationInList:
...
async def retrieve_workspace_service_history_by_workspace_service_id(workspace_service=Depends(get_workspace_service_by_id_from_path), resource_history_repo=Depends(ResourceHistoryRepository.get_repository())) -> ResourceHistoryInList:
...
async def retrieve_user_resources_for_workspace_service(
        ...
        user_resource_repo=Depends(UserResourceRepository.get_repository())) -> UserResourcesInList:
...
async def delete_user_resource(
        ...
        operations_repo=Depends(OperationRepository.get_repository()),
        resource_template_repo=Depends(ResourceTemplateRepository.get_repository()),
        resource_history_repo=Depends(ResourceHistoryRepository.get_repository())) -> OperationInResponse:
    validate_user_has_valid_role_for_user_resource(user, user_resource)
...
async def retrieve_user_resource_operations_by_user_resource_id(
        user_resource=Depends(get_user_resource_by_id_from_path),
        user=Depends(get_current_workspace_owner_or_researcher_user_or_airlock_manager),
        operations_repo=Depends(OperationRepository.get_repository())) -> OperationInList:
    validate_user_has_valid_role_for_user_resource(user, user_resource)
...
async def retrieve_user_resource_history_by_user_resource_id(user_resource=Depends(get_user_resource_by_id_from_path), user=Depends(get_current_workspace_owner_or_researcher_user_or_airlock_manager), resource_history_repo=Depends(ResourceHistoryRepository.get_repository())) -> ResourceHistoryInList:
    validate_user_has_valid_role_for_user_resource(user, user_resource)
