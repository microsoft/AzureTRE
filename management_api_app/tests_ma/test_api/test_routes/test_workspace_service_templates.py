...
class TestWorkspaceServiceTemplatesRequiringAdminRights:
    ...
    async def test_get_workspace_service_templates_returns_template_names_and_description(self,
    ...
    @patch("api.routes.workspace_service_templates.ResourceTemplateRepository.get_current_resource_template_by_name")
    async def test_workspace_service_templates_by_name_returns_enriched_workspace_service_template(self, get_workspace_service_template_by_name_mock,
                                                                                                   workspace_service_template_without_enriching,
                                                                                                   app: FastAPI, client: AsyncClient):
