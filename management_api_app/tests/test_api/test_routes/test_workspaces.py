...
@patch("validation.validate_request.ValidateRequest.validate_workspace_request")
async def test_workspaces_post_creates_workspace(validate_workspace_request_mock, create_workspace_item_mock, save_workspace_mock, send_resource_request_message_mock, app: FastAPI, client: AsyncClient):
    workspace_id = "000000d3-82da-4bfc-b6e9-9a7853ef753e"
    validate_workspace_request_mock.return_value = None
...
@patch("api.routes.workspaces.WorkspaceRepository.create_workspace_item")
@patch("validation.validate_request.ValidateRequest.validate_workspace_request")
async def test_workspaces_post_calls_db_and_service_bus(validate_workspace_request_mock, create_workspace_item_mock, save_workspace_mock, send_resource_request_message_mock, app: FastAPI, client: AsyncClient):
    workspace_id = "000000d3-82da-4bfc-b6e9-9a7853ef753e"
    validate_workspace_request_mock.return_value = None
    create_workspace_item_mock.return_value = create_sample_workspace_object(workspace_id)
    input_data = create_sample_workspace_input_data()
...
@patch("api.routes.workspaces.WorkspaceRepository.create_workspace_item")
@patch("validation.validate_request.ValidateRequest.validate_workspace_request")
async def test_workspaces_post_returns_202_on_successful_create(validate_workspace_request_mock, create_workspace_item_mock, save_workspace_mock, send_resource_request_message_mock, app: FastAPI, client: AsyncClient):
    workspace_id = "000000d3-82da-4bfc-b6e9-9a7853ef753e"
    validate_workspace_request_mock.return_value = None
    create_workspace_item_mock.return_value = create_sample_workspace_object(workspace_id)
    input_data = create_sample_workspace_input_data()
...
@patch("api.routes.workspaces.WorkspaceRepository.create_workspace_item")
@patch("validation.validate_request.ValidateRequest.validate_workspace_request")
async def test_workspaces_post_returns_503_if_service_bus_call_fails(validate_workspace_request_mock, create_workspace_item_mock, save_workspace_mock, send_resource_request_message_mock, app: FastAPI, client: AsyncClient):
    workspace_id = "000000d3-82da-4bfc-b6e9-9a7853ef753e"
    validate_workspace_request_mock.return_value = None
    create_workspace_item_mock.return_value = create_sample_workspace_object(workspace_id)
    input_data = create_sample_workspace_input_data()
...
@patch("validation.validate_request.ValidateRequest.validate_workspace_request")
async def test_workspaces_post_returns_400_if_template_does_not_exist(validate_workspace_request_mock, get_template_version_mock, app: FastAPI, client: AsyncClient):
    validate_workspace_request_mock.return_value = None
