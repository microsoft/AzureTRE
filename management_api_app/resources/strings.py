...
# Error strings
INVALID_WORKSPACE_REQUESTS_IN_DB = "Some workspace requests in the state store do not conform to the workspace request schema"
INVALID_TEMPLATES_IN_DB = "Some templates in the state store do not conform to the template schema"
STATE_STORE_ENDPOINT_NOT_RESPONDING = "State Store endpoint is not responding"
UNSPECIFIED_ERROR = "Unspecified error"
UNABLE_TO_READ_TEMPLATES = "Unable to read templates from the state store"
UNABLE_TO_SAVE_THE_WORKSPACE_REQUEST = "Unable to save the workspace request in the state store"
