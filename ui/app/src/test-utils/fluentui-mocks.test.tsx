...
describe("fluentui mocks normalizations", () => {
  const { Spinner, Dialog, Panel, TooltipHost, Dropdown } = createFluentUIMocks();
  ...
  test("Panel maps isLightDismiss and closeButtonAriaLabel correctly", () => {
    render(
      (
        <Panel isOpen onDismiss={() => {}} headerText="Header" isLightDismiss closeButtonAriaLabel="close panel" />
      ) as any,
    );
