...
describe("ErrorPanel Component", () => {
  ...
  it("renders panel when isOpen is true", () => {
    render(<ErrorPanel errorMessage="Test error message" isOpen={true} onDismiss={mockOnDismiss} />);
  ...
  it("does not render panel when isOpen is false", () => {
    render(<ErrorPanel errorMessage="Test error message" isOpen={false} onDismiss={mockOnDismiss} />);
  ...
  it("displays error message", () => {
    ...
    render(<ErrorPanel errorMessage={errorMessage} isOpen={true} onDismiss={mockOnDismiss} />);

    expect(screen.getByText(errorMessage)).toBeInTheDocument();
  });

  it("calls onDismiss when close button is clicked", () => {
    render(<ErrorPanel errorMessage="Test error" isOpen={true} onDismiss={mockOnDismiss} />);
  ...
  it("strips ANSI codes from error message", () => {
    ...
    render(<ErrorPanel errorMessage={errorWithAnsi} isOpen={true} onDismiss={mockOnDismiss} />);
  ...
  it("replaces special characters with newlines", () => {
    ...
    render(<ErrorPanel errorMessage={errorWithSpecialChars} isOpen={true} onDismiss={mockOnDismiss} />);
  ...
  it("trims whitespace from error message", () => {
    ...
    render(<ErrorPanel errorMessage={errorWithWhitespace} isOpen={true} onDismiss={mockOnDismiss} />);
  ...
  it("preserves whitespace in error message", () => {
    ...
    render(<ErrorPanel errorMessage={errorWithFormatting} isOpen={true} onDismiss={mockOnDismiss} />);
    ...
    const errorElement = screen.getByText((content: string) => {
      return Boolean(
        content && content.includes("Line 1") && content.includes("Indented line") && content.includes("Line 3"),
      );
    });
