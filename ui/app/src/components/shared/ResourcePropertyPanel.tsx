      ...
      <Stack wrap horizontal>
        <Stack grow styles={stackStyles}>
          <ResourcePropertyPanelItem
            header={"Resource ID"}
            val={props.resource.id}
          />
          <ResourcePropertyPanelItem
            header={"Resource type"}
            val={props.resource.resourceType}
          />
          <ResourcePropertyPanelItem
            header={"Resource path"}
            val={props.resource.resourcePath}
          />
          <ResourcePropertyPanelItem
            header={"Template name"}
            val={props.resource.templateName}
          />
          <ResourcePropertyPanelItem
            header={"Template version"}
            val={props.resource.templateVersion}
          />
          <ResourcePropertyPanelItem
            header={"Is enabled"}
            val={props.resource.isEnabled.toString()}
          />
          <ResourcePropertyPanelItem
            header={"User"}
            val={props.resource.user.name}
          />
          <ResourcePropertyPanelItem
            header={"Last updated"}
            val={moment
