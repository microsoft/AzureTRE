...
describe("useAuthApiCall Hook", () => {
  ...
  const mockTokenResponse = {
    accessToken:
      "eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9.eyJyb2xlcyI6WyJUUkVBZG1pbiJdLCJzdWIiOiJ0ZXN0LXVzZXIifQ.test-signature",
    account: mockAccount,
  };
  ...
  it("makes a GET request successfully", async () => {
    ...
    expect(global.fetch).toHaveBeenCalledWith("https://test-api.example.com/api/test", {
      mode: "cors",
      headers: {
