locals {
  ...
  data_deletion_topic_name  = "evgt-airlock-data_deletion-${local.topic_name_suffix}"
  ...
  data_deletion_queue_name  = "airlock-data_deletion"
  ...
  data_deletion_eventgrid_subscription_name     = "evgs-airlock-data_deletion"
