locals {
  core_services_vnet_subnets               = cidrsubnets(var.core_address_space, 4, 4, 4, 4, 2, 4, 4, 4, 4)
  ...
  airlock_processor_subnet_address_prefix  = local.core_services_vnet_subnets[7] # .0 - .254
  airlock_storage_subnet_address_prefix    = local.core_services_vnet_subnets[8] # .0 - .254
  tre_core_tags = {
    tre_id              = var.tre_id
