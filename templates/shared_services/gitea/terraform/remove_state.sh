...
remove_if_present module.gitea.azurerm_user_assigned_identity.gitea_id
remove_if_present module.gitea.random_password.gitea_passwd
remove_if_present module.gitea.azurerm_firewall_application_rule_collection.web_app_subnet_gitea
