...
import_if_exists azurerm_key_vault_secret.gitea_password "/subscriptions/${ARM_SUBSCRIPTION_ID}/resourceGroups/${RESOURCE_GROUP_ID}/providers/Microsoft.KeyVault/vaults/kv-${TRE_ID}/secrets/gitea-${TRE_ID}-admin-password"
