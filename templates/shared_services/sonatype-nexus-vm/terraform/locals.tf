locals {
  ...
  windows_nexus_allowed_fqdns = "r3.o.lencr.org,x1.c.lencr.org,*.digicert.com,ocsp.godaddy.com,crl.godaddy.com"
  windows_nexus_allowed_fqdns_list = distinct(compact(split(",", replace(local.windows_nexus_allowed_fqdns, " ", ""))))
