...
# The storage account lives in the core resource group, which may be in a different
# subscription — pin to azurerm.core so lookups work in split-subscription deployments.
